...
class EnvReplayBuffer(SimpleReplayBuffer):
    ...
    def meta_random_batch(self, batch_size, meta_size=50000):
        low = max(0, self._size - meta_size)
        indices = np.random.randint(low, self._size, size=batch_size)
        batch = dict(
